...
*
* @package  CssArray
* @author   Syahrul Farhan <syahrul.farhan@gmail.com>
...
class CssArray {
     ...
     * @param [array] $style  [CSS Style]
     * @param [array] $result [Result reference from the main function]
     */
    ...
    /**
     * Break @media CSS
     * @param  [array] $style [CSS media style]
     ...
     * @param  [string] $content [string that start with @media]
     * @param  [array] $result  [Result reference from the main function]
     ...
     * @param  [array] $result  [Reference from the main function]
